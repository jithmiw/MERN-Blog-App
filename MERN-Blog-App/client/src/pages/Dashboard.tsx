...
function Dashboard({ posts, setPosts }: IProps) {
  ...
  useEffect(() => {
    document.title = "Dashboard | Blog World";
  }, []);

  return (
    <div>
      <h1 className="text-3xl border-b-2 text-center m-8 font-sans uppercase">Dashboard</h1>
            ...
            return (
              ...
              >
                ...
                <button
                  ...
                  className="px-4 py-1 mt-2 rounded border text-sm border-black text-black duration-300 hover:text-white hover:bg-black"
                >
