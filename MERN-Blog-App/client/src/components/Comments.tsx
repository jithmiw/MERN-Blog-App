          ...
          .map((comment: IComment, i: number) => {
            return (
              ...
              >
                ...
                >
                  ...
                  <form onSubmit={() => handleUpdate(comment)}>
                    ...
                    <input
                      ...
                      className="w-full mb-2 text-gray-900 text-base leading-5 h-8 rounded bg-gray-100 py-1 px-2 duration-100 border-2 shadow-sm outline-0 focus:border-black"
                      required
                    />
                  </form>
                </div>
                ...
                >
                  <button
                    className="px-2 py-1 mt-2 mr-1 rounded border border-red-600 text-red-600 duration-300 hover:text-white hover:bg-red-600"
                    onClick={() => setIsEditing(false)}
                  >
                    Cancel
                  </button>
                  <button
                    className="px-2 py-1 mt-2 rounded border border-black text-black duration-300 hover:text-white hover:bg-black"
                ...
                >
                  <button
                    ...
                    className="px-2 py-1 mt-2 mr-1 rounded border border-black text-black duration-300 hover:text-white hover:bg-black"
                  >
                    <BiEdit />
                  </button>
                  <button
